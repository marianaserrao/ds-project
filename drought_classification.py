...
def setBoxplotInterval(data=pd.DataFrame, tupleIntervals=[tuple]):
    ...
    for entry in tupleIntervals: 
        tmpDF = dataDescript[(dataDescript['min']<=entry[0]) & (dataDescript['max']<entry[1])]
...
boxplotIntervals = setBoxplotInterval(data, [(-100, 0), (0, 1), (1, 10), (10, 50), (50, 120), (120, 1000), (1000, 11), (2000, 2017)])
labelFilename = 0
for inter in boxplotIntervals:
    sboxplot(data[inter.columns], 'boxplot'+str(labelFilename))
    labelFilename+=1
